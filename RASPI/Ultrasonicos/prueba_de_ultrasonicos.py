...
def medir_distancia(TRIG, ECHO, timeout=0.1):  # aumentamos timeout a 0.1s
    # Enviar pulso de 10us al TRIG
    GPIO.output(TRIG, False)
    time.sleep(0.0001)  # pequeño retardo antes del disparo
    ...
    while GPIO.input(ECHO) == 0:
        ...
        if pulse_start - start_time > timeout:
            return None  # sin lectura (timeout)
...
try:
    while True:
        ...
        print("--------------------------")
        time.sleep(0.2)  # más tiempo entre mediciones
